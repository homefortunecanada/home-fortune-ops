...
export const I18N = {
  en: {
    ...
    'item.room':'Room','item.install':'Installation','item.edit':'Edit','item.duplicate':'Duplicate','item.delete':'Delete','item.calculate':'Calculate','item.recalculate':'Recalculate',
    ...
    'confirm.deleteItem':'Delete {item}? This removes it from the order permanently and cannot be undone.',
    ...
    'act.addedItem':'Added {item}','act.itemUpdated':'{item} updated','act.deletedItem':'Deleted {item}',
    ...
    'quote.screenIncludedLine':'Window screen included ({screen})','quote.screenStandard':'Standard','quote.includedFree':'Included',
  ...
  zh: {
    ...
    'item.room':'房间','item.install':'安装','item.edit':'编辑','item.duplicate':'复制','item.delete':'删除','item.calculate':'计算','item.recalculate':'重新计算',
    ...
    'confirm.deleteItem':'删除 {item}？此操作将永久从订单中移除该项目，且无法撤销。',
    ...
    'act.addedItem':'已添加 {item}','act.itemUpdated':'{item} 已更新','act.deletedItem':'已删除 {item}',
    ...
    'quote.screenIncludedLine':'含窗纱（{screen}）','quote.screenStandard':'标准款','quote.includedFree':'已包含',
